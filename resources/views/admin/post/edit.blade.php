    ...
    @include('admin.messages.errors')
              ...
              {{method_field('PUT')}}
                ...
                <div class="col-lg-6 pull-right">
                  ...
                  <select class="form-control select2 select2-hidden-accessible" multiple="" name="tags[]" data-placeholder="Select a Tags" style="width: 100%;" tabindex="-1" aria-hidden="true">
                    @foreach ($tags as $tag)
          ...
          <div class="card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                <textarea id="editor1" name="body" placeholder="Place some text here"  style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $post->body }}</textarea>
              </div>
